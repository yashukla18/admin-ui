...
export const ETHNICITY_OPTIONS: Option[] = [
  { label: 'Asian American / Pacific Islander', value: 'asian-american-pacific-islander' },
  {
    label: 'Native American / American Indian / Alaskan Native',
    value: 'native-american-american-indian-alaskan-native',
  },
  { label: 'Black / African American', value: 'black-african-american' },
  { label: 'White / European American', value: 'white-european-american' },
  { label: 'Hispanic / Latino American', value: 'hispanic-latino-american' },
  { label: 'Other / Multicultural', value: 'other-multicultural' },
